...
This system is a rising-steel system that you can use as a starting point for building your own custom systems. It's similar to Simple World-building, but has examples of creating attributes in code rather than dynamically through the UI.

**Configuration:** [system.json](https://github.com/Terule/ex_aa/blob/main/system.json)

## Usage

There are two ways to get started: using the RisingSteel system generator command or manually renaming and updating files.
...
> **Python Generator**
> 
> If you would rather use Python than node, there’s an excellent Python-based generator created by Cussa at https://github.com/Cussa/fvtt-rising-steel-initializator. Give it a shot!
...
Before installing this system, you should rename any files that have `rising-steel` in their filename to use whatever machine-safe name your system needs, such as `adnd2e` if you were building a system for 2nd edition Advanced Dungeons & Dragons. In addition, you should search through the files for `rising-steel` and `RisingSteel` and do the same for those, replacing them with appropriate names for your system.
...
Head over to the [Vue3RisingSteel System](https://gitlab.com/asacolips-projects/foundry-mods/vue3rising-steel) repo if you're interested in using Vue!
...
![image](http://mattsmith.in/images/rising-steel.png)
